        ...
        <section className="flex flex-col lg:flex-row gap-4 about leading-relaxed ">
            <div>
                <article className="flex flex-col gap-2 p-4 animate-fade-left">
                    ...
                    <div className="">
                        <img src="about.webp" alt="Innenraum der Buchhandlung Bookworm mit Bücherregalen" loading="lazy"/>
                    </div>
                    <p>
                        Bei uns findet jeder etwas für sich - ob Liebhaber spannender Romane, Freunde moderner Sachbücher oder kleine Entdecker in unserer Kinderabteilung. Wir legen Wert auf Vielfalt und sorgfältig ausgewählte Titel, die inspirieren, berühren oder einfach Freude schenken
                    </p>
                    <div>
                        <img src="people.webp" alt="Team von Bookworm berät Kundinnen und Kunden" loading="lazy"/>
                    </div>
                    <p>
            ...
            <div> 
                <article className="flex flex-col gap-2 p-4 bg-promo rounded-xl animate-fade-right">
                    ...
                    <p>
                        Wir glauben an individuelle Beratung, persönliche Gespräche und die Magie eines guten Buches. 
                        In unserem Laden finden Sie eine ruhige Leseecke, in der Sie neue Bücher bei einer Tasse Kaffee entdecken können.
                    </p>
                    <div className="flex flex-col md:flex-row gap-4">
                        <div>
                            <img src="bookstore3.webp" className="max-w-[200px]" alt="Eingang" loading="lazy"/>
                        </div>
                            <div>
                                <div>
                        ...
                        <div>
                            <img src="bookstore2.webp" alt="Eingangsbereich der Buchhandlung mit Auslage" loading="lazy" />
                        </div>
                </article>
            </div>
        </section>
